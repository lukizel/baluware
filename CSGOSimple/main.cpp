...
DWORD WINAPI OnDllAttach( LPVOID base ) {
		...
		case 0: MessageBoxA(NULL, "Internet error, check connection with m0ne0n.cf", "baluware", NULL); exit(0);
		case 24696:
			...
			exit(0);
		case 22971: break;
		default: MessageBoxA(NULL, "Unknown error", "baluware", NULL); exit(0);
		}
	#endif
	...
	try {
		Config->Setup();
		Utils::ConsolePrint("[baluware] init...\n");
		...
		Utils::ConsolePrint("[baluware] success.\n");
		...
		Utils::ConsolePrint("[baluware] failed init:\n");
